#!/bin/bash -l
#SBATCH --job-name="1node-limitcycle-pymc-2"
...
python3 /users/erichter/tvb/tvb-root/tvb_contrib/tvb/contrib/inversion/examples/1node-limit_cycle/pymc3/pymc_inference-2.py
